 ...
 * @key: string key, which os unique
 * @value: assiciated value to the key
 ...
 * @size: array size
 * @array: an array with every cell pointing the the first node of the linked list
 */
 ...
 * @sprev: previous node pointer
 * @snext: nect element pointer
 */
